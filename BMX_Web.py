...
# --- REGLAS CSS PARA LOGRAR CABECERA AZUL Y CONSERVAR SOLO LOS 3 PUNTOS ---
st.markdown("""
<style>
/* 1. Pintar la franja superior blanca con el color azul corporativo de tu marca */
...
/* 2. CONFIGURACIÓN DE GADGETS: Ocultar botones "Fork", el logo del gato y enlaces de la nube */
...
/* 3. CONSERVAR LOS 3 PUNTOS: Forzar la visibilidad del botón principal del menú nativo */
...
/* 4. Forzar que los botones de expandir/contraer el sidebar y de impresión queden encima */

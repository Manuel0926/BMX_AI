...
# --- REGLAS CSS TOTALES: ENMASCARA EL DROPDOWN EXTERNO Y LIBERA SÓLO LOS 3 PUNTOS ---
st.markdown("""
<style>
/* 1. Pintar la franja superior completa con el color azul corporativo de tu marca */
...
/* Ocultar la línea decorativa superior original de Streamlit */
[data-testid="stDecoration"] {
    visibility: hidden !important;
    display: none !important;
}

/* 2. ENMASCARAMIENTO DE CAPA FLOTANTE: Apunta al bloque secundario inyectado para borrar Fork y Gato */
div[class*="stAppDeployDropdown"] > div:not(#MainMenu),
div[class*="stAppDeployDropdown"] > button:not(#MainMenu),
.stActionButton, .stMainActionButton, [data-testid="stActionButton"],
header a, .stAppHeader a, button:has(svg[class*="github"]), button:contains("Fork") {
    visibility: hidden !important;
    display: none !important;
}

/* 3. LIBERACIÓN INVERSA: Forzar visibilidad estricta sobre el selector de los 3 puntos nativos */
button#MainMenu, #MainMenu, [data-testid="stHeader"] button:last-child, button[id*="MainMenu"] {
    visibility: visible !important;
    display: inline-flex !important;
    z-index: 999999 !important;
}

/* 4. Asegurar el libre movimiento de los botones de expandir/contraer el sidebar */
...
/* 5. Asegurar el color de fondo azul en el cuerpo general de la aplicación */
.stApp {
    background-color: #7CB4E6 !important;
}

/* 6. Ocultar la barra inferior 'Manage app' y el pie de página de la nube */

                        ...
                        if resultado:
                            ...
                            if activo == 1:
                                ...
                                if limite_superado:
                                    ...
                                    st.error(
                                        "Ya se cumplio el alcance del plan, si desea continuar debe adquirir de nuevo un plan.")
                                else:
...
if st.session_state.get("plan_superado", False):
    st.markdown("""
        <div style="background-color: #ff4b4b; padding: 25px; border-radius: 12px; border: 1px solid #000000; text-align: center; margin-top: 20px;">
            <h2 style="color: #ffffff; font-weight: bold; font-size: 1.0rem; margin: 0;">
                ⚠️ Ya se cumplio el alcance del plan, si desea continuar debe adquirir un nuevo plan
            </h2>
        </div>
    """, unsafe_allow_html=True)
    st.stop()

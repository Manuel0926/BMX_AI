...
# --- TRUCO CSS MAESTRO: PERMITE PASAR CLICS A TRAVÉS DE LA CABECERA ---
st.markdown("""
<style>
...
/* 3. CORRECCIÓN CRÍTICA: Hacer que el mouse ignore la cabecera para que no bloquee los clics */
header, [data-testid="stHeader"], .stAppHeader {
    visibility: visible !important;
    background-color: transparent !important;
    display: flex !important;
    justify-content: flex-end !important;
    pointer-events: none !important; /* El mouse atraviesa la barra */
}
...
/* Devolverle de forma explícita los clics únicamente a los botones interactivos (Imprimir y Sidebar) */
button[data-testid="stHeaderActionButton"], [data-testid="stHeaderActionButton"], button[data-testid="stSidebarCollapseButton"] {
    ...
    pointer-events: auto !important; /* Estos botones sí reciben clics */
}

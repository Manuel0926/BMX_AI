...
# --- CONFIGURACIÓN DE LA PÁGINA CORREGIDA ---
# Forzamos a que el sidebar se cargue explícitamente expandido por defecto
st.set_page_config(
...
# --- CONTROL CSS MEJORADO: COMPATIBLE CON EL EXPANDIDO NATIVO ---
st.markdown("""
<style>
/* 1. Ocultar la línea decorativa superior y el menú de tres puntos original */
...
/* 3. Hacer visible el encabezado pero transparente para que no bloquee las interacciones del sidebar */
...
/* Aplicación del fondo azul corporativo al cuerpo principal */
.stApp {
    background-color: #7CB4E6 !important;
}

/* Asegurar visibilidad total de los botones nativos de colapso de barra y de impresión */

                        ...
                        if resultado:
                            ...
                            if activo == 1:
                                ...
                                if plan == "Plan Oro" and (dias_transcurridos > 60 or current_cont >= 20):
                                    ...
                                    limite_superado = True
                                elif plan == "Plan Bronce" and (dias_transcurridos > 20 or current_cont >= 5):
                                    limite_superado = True

                                if limite_superado:
                                    st.session_state.plan_superado = True
                                    st.error(
                                        "Ya se cumplio el alcance del plan, si desea continuar debe adquirir un plan nuevo")
                                else:
...
if st.session_state.get("plan_superado", False):
    st.markdown("""
        <div style="background-color: #ff4b4b; padding: 25px; border-radius: 12px; border: 2px solid #000000; text-align: center; margin-top: 20px;">
            <h2 style="color: #ffffff; font-weight: bold; font-size: 1.8rem; margin: 0;">
                ⚠️ Ya se cumplio el alcance del plan, si desea continuar debe adquirir un plan nuevo
            </h2>
        </div>
    """, unsafe_allow_html=True)
    st.stop()

...
/* Forzar que el botón nativo de Share permanezca visible si se requiere imprimir o compartir */
header button:has(svg.bi-share), header button[title*="Share"], [data-testid="stHeaderActionButton"]:has(svg) {
...
# --- ARREGLO CRÍTICO: Inicialización forzada de todos los estados de memoria ---

...
# --- INTERFAZ PREMIUM QUE PERMITE IMPRIMIR PERO OCULTA DESARROLLO ---
st.markdown("""
<style>
/* 1. Ocultar el menú de tres puntos y la decoración de color superior */
#MainMenu, [data-testid="stDecoration"] {
    visibility: hidden !important;
    display: none !important;
}

/* Permitir y dar estilo limpio al botón nativo de Share / Print en el encabezado */
...
/* 2. Ocultar de raíz la barra flotante inferior de 'Manage app' y el pie de página */
...
/* Formato optimizado para impresión en PDF físico libre de barras o menús de fondo */
@media print {

...
# --- REGLAS CSS ULTRA PRECISAS PARA CONSERVAR ÚNICAMENTE LOS 3 PUNTOS ---
st.markdown("""
<style>
/* 1. Pintar la franja superior con el color azul corporativo de tu marca */
...
/* 2. OCULTAR GADGETS EXTERNOS: Borra selectores de Fork, el icono del gato y los badges de GitHub */
.stActionButton, .stMainActionButton, [data-testid="stActionButton"],
header a, .stAppHeader a,
button:has(svg[class*="github"]), button:contains("Fork"),
div[data-testid="stAppDeployDropdown"] > div:not(#MainMenu),
[data-testid="stAppDeployDropdown"] > button:not(#MainMenu) {
    visibility: hidden !important;
    display: none !important;
}

/* 3. CONSERVAR EXCLUSIVAMENTE LOS 3 PUNTOS: Forzar la visibilidad del botón de menú nativo */
button#MainMenu, #MainMenu, [data-testid="stHeader"] button:last-child {
    visibility: visible !important;
    display: inline-flex !important;
    z-index: 999999 !important;
}

/* 4. Forzar que los botones de expandir/contraer el sidebar queden encima */

...
/* --- RECTIFICACIÓN PROPORCIONAL: REDUCCIÓN DEL 10% SÓLO EN LA BARRA LATERAL --- */
[data-testid="stSidebar"] *, [data-testid="stSidebar"] p, [data-testid="stSidebar"] span, [data-testid="stSidebar"] label, [data-testid="stSidebar"] input, [data-testid="stSidebar"] select {
    font-size: 0.85rem !important; /* Reducción exacta del 10% sobre la base estándar */
}
...
/* Título de la marca en el Sidebar adaptado a la reducción del 10% */
.sidebar-brand-title { 

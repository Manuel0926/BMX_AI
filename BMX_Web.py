...
# --- REGLAS CSS PARA REMOVER DISPOSITIVOS DE LA NUBE Y DAR ESPACIADO EXTRA ---
st.markdown("""
<style>
...
/* Forzar un margen superior seguro para que los títulos no se peguen arriba ni se recorten */
.block-container {
...
LOCALES = {
    "es": {
        ...
        "bienvenida_html": """
<div style="font-family: sans-serif; line-height: 1.6; background-color: #7CB4E6; padding: 10px; margin: 0 auto; color: #000000; max-width: 1100px; width: 100%;">
<div style="text-align: center; margin-bottom: 35px;">
    <h2 style="color: #000000; font-weight: 800; font-size: 2.2rem; margin: 0 0 10px 0; font-family: sans-serif;">Consulta BMX Old School</h2>
    <div style="width: 320px; height: 3px; background-color: #000000; margin: 0 auto 30px auto;"></div>
    <h3 style="color: #000000; font-weight: 800; font-size: 1.55rem; margin: 0; font-family: sans-serif;">¡Bienvenidos a la fuente oficial del BMX Old School!</h3>
</div>
<table style="width: 100%; border-collapse: collapse; border: none; margin-top: 10px;">
<tr>
<td style="width: 53%; vertical-align: top; padding-right: 35px; border-right: 2px solid #000000; text-align: justify;">
<p style="font-size: 1.05rem; margin-top: 0; margin-bottom: 18px; color: #000000;">Este es el espacio donde nuestros recuerdos hoy se convierten en <strong>pasión</strong>. Gracias al poder de la <strong>Inteligencia Artificial (modelo RAG)</strong>, dejamos atrás los mitos y las leyendas urbanas.</p>
<p style="font-size: 1.05rem; margin-bottom: 0; color: #000000;">Ahora tienes el power de interrogar directamente a las <strong>fuentes oficiales de la época</strong>: revistas, catálogos de bicicletas y repuestos, pruebas de rendimiento de fábrica y mucho más. Todo en un solo lugar para que <strong>certifiques tu conocimiento</strong> con datos reales.</p>
</td>
<td style="width: 47%; vertical-align: top; padding-left: 35px; text-align: left;">
<h4 style="margin-top: 0; color: #000000; font-weight: 800; font-size: 1.25rem; margin-bottom: 15px; font-family: sans-serif;">¡Inicia ahora!</h4>
<p style="margin: 0 0 12px 0; font-size: 1.02rem; color: #000000; line-height: 1.5;">1. Regístrate y valida tu acceso con tu correo electrónico en la barra lateral.</p>
<p style="margin: 0 0 20px 0; font-size: 1.02rem; color: #000000; line-height: 1.5;">2. Realiza tus consultas y exporta los resultados en un documento PDF listo para imprimir.</p>
<p style="font-style: italic; font-size: 0.95rem; margin-top: 25px; margin-bottom: 15px; color: #000000; line-height: 1.4;">Esta herramienta está hecha por y para la comunidad. Contamos contigo para evolucionar, aprender, corregir y mejorar este proyecto juntos.</p>
<p style="margin-top: 20px; margin-bottom: 0; font-weight: bold; color: #000000; font-size: 1.02rem; font-family: sans-serif;">Atentamente,<br><br>Manuel Sanabria</p>
</td>
</tr>
</table>
</div>
...
if not st.session_state.suscrito:
    # Renderizado unificado responsivo mediante HTML controlado de alta precisión

...
if st.session_state.sidebar_visible:
    ...
    if st.button(L["cerrar_sesion"]):
        ...
        st.rerun()
# --- ÁREA CENTRAL ---
# Configuración de los dos botones superiores en la rejilla de control
...
with col_control_2:
    # CORRECCIÓN DE OPERACIÓN: Se añade 'window.parent.print()' para saltar el Iframe e imprimir la app completa
    st.markdown(

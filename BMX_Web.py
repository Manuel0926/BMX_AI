...
# --- INTERFAZ PREMIUM CON MENÚS FILTRADOS (SHARE VISIBLE) ---
st.markdown("""
<style>
...
/* 2. Ocultar por completo la barra flotante de 'Manage app' y el pie de página de Streamlit */
...
/* Opciones de diseño optimizadas para la exportación o impresión física del documento */
@media print {
...
class BMXWebScanner:
    ...
    def _inicializar_db(self):
        ...
        # Modificación dinámica de columnas
    ...
    def obtener_cliente(self):
        # Extracción segura desde los secretos de tu aplicación en Streamlit
...
<p style="font-style: italic; font-size: 0.85rem; margin-top: 12px; color: #000000;">Esta herramienta está hecha por y para la comunidad. Contamos contigo para evolucionar, aprender, corregir and mejorar este proyecto juntos.</p>
...
with st.sidebar:
    ...
    # PROCESAMIENTO ESTABLE DEL ARCHIVO GIF DESDE EL REPOSITORIO LOCAL EN BYTES (MAYÚSCULA FIEL)
    try:

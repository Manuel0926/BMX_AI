...
# Forzamos que la interfaz nativa de Streamlit siempre intente iniciar expandida
st.set_page_config(
...
st.markdown("""
<style>
/* 1. Apagar por completo el bloque superior de Streamlit y TODOS los controles nativos de colapso */
header, 
...
/* Forzar la eliminación de la flecha nativa interna de cierre (<<) dentro de la barra lateral */
...
# Forzamos que la variable de control de tu botón personalizado inicie siempre en True (Expandido)
...
if st.session_state.sidebar_visible:
    ...
    # Si colapsamos con tu botón manual, forzamos la desaparición visual completa del contenedor lateral
    st.markdown("""<style>[data-testid="stSidebar"] { display: none !important; }</style>""", unsafe_allow_html=True)
# --- ÁREA CENTRAL ---
# Único botón de alternancia permitido en pantalla

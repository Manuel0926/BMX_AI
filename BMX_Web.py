...
/* Mantener el esquema de color azul premium unificado en todos los botones */
    ...
    with st.sidebar:
        ...
        if not st.session_state.suscrito:
            ...
            if st.button(L["cerrar_sesion"]):
                ...
                st.rerun()
# --- ÁREA CENTRAL ---
# El botón de imprimir se remueve por completo y el control se reduce a su mínima expresión
col_control, _ = st.columns([1, 11])  # Rejilla asimétrica para mantener el botón pequeño a la izquierda

with col_control:
    # RECTIFICACIÓN INTERFAZ: El botón ahora utiliza únicamente los caracteres estéticos indicados

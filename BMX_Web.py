...
# --- CONTROL CSS COMPLETO: OCULTA GADGETS Y DEJA SOLO EL BOTÓN DE IMPRESIÓN ---
st.markdown("""
<style>
/* 1. Ocultar la línea decorativa superior y el menú de tres puntos nativo */
[data-testid="stDecoration"], button#MainMenu, #MainMenu {
    visibility: hidden !important;
    display: none !important;
}

/* 2. Ocultar específicamente los botones de GitHub (Gato y Fork) inyectados en la cabecera */
.stActionButton, .stMainActionButton, [data-testid="stActionButton"] {
    visibility: hidden !important;
    display: none !important;
}

/* 3. Forzar que el encabezado y el área de acción permanezcan activos */

...
# --- TRUCO CSS MAESTRO: FULMINA CUALQUIER ELEMENTO O ACCIÓN DE STREAMLIT CLOUD ---
st.markdown("""
<style>
...
/* 3. REFUERZO RADICAL ANTI-GADGETS: Desactiva por completo los botones flotantes de Host, Feedback, Corona y Tooltips */
...
div[class*="stConnectionStatus"] + div, div[class*="stApp"] + div, body > div:not(.stApp):not([data-testid="stSidebar"]) {
    ...
    display: none !important;
    opacity: 0 !important;
    pointer-events: none !important; /* El mouse ignora por completo la zona evitando ventanas emergentes */
}

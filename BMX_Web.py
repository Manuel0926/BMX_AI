...
/* ELIMINACIÓN DEFINITIVA DE LA FLECHA INTERNA (<<): 
   Ataca estructuralmente a cualquier botón nativo de colapso en el contenedor superior del sidebar */
...
/* Forzado secundario por herencia CSS para asegurar que no se dibuje el ícono de la flecha */
[data-testid="stSidebarCollapseButton"] {
    display: none !important;
    visibility: hidden !important;
}

/* Garantizar que tus botones legítimos creados con st.button() SÍ se muestren */
...
# Garantizamos que la pantalla inicie en estado Expandido de forma manual

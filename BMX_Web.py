...
# --- CONFIGURACIÓN DE LA PÁGINA RECTIFICADA ---
st.set_page_config(
    page_title="BMX.AI Premium",
    page_icon="🚲",
    layout="wide",  # Corregido: "wide" es el parámetro oficial válido
...
# --- CONTROL CSS DEFINITIVO: OCULTA GADGETS SIN ENCRIPTAR NI ESTIRAR LAS CAPAS ---
st.markdown("""
<style>
/* 1. Ocultar la línea decorativa superior de Streamlit y el botón de tres puntos */
[data-testid="stDecoration"], button#MainMenu, #MainMenu {
    visibility: hidden !important;
    display: none !important;
}

/* 2. Ocultar de manera limpia los botones de Fork y GitHub del encabezado */
.stActionButton, .stMainActionButton, [data-testid="stActionButton"], 
.stAppHeader button:not([data-testid="stHeaderActionButton"]) {
    visibility: hidden !important;
    display: none !important;
}

/* 3. Estilizar la cabecera conservando su espacio natural para que no tape la flecha del sidebar */
header, [data-testid="stHeader"], .stAppHeader {
    visibility: visible !important;
    background-color: #7CB4E6 !important;
}

/* Forzar que el contenedor principal mantenga el fondo azul corporativo */
.stApp {
    background-color: #7CB4E6 !important;
}

/* Liberar de forma explícita el botón nativo de Share/Imprimir y la flecha del sidebar */
...
/* 4. Ocultar la barra flotante inferior 'Manage app' y el pie de página de Streamlit */

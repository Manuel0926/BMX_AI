...
# --- ELIMINACIÓN ABSOLUTA DE GADGETS Y INTEGRACIÓN DE ESTILOS ---
st.markdown("""
<style>
...
/* BLOQUEO SEGURO DE BOTONES INFERIORES: Inhabilita visualmente los botones de soporte sin romper el layout */

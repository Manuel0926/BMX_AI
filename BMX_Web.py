...
if st.session_state.get("plan_superado", False):
    st.markdown("""
        <div style="background-color: #ff4b4b; padding: 35px; border-radius: 10px; border: 1px solid #ffffff; text-align: center; margin-top: 20px;">
            <h2 style="color: #ffffff; font-weight: bold; font-size: 1.5rem; margin: 0;">

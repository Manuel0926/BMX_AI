...
# --- CSS DEFINITIVO: DESACTIVA E INVISIBILIZA CUALQUIER ELEMENTO INYECTADO POR EL SERVIDOR ---
st.markdown("""
<style>
...
/* 3. BLOQUEO TOTAL DE GADGETS INFERIORES: Elimina los botones de Host, Feedback, Corona y cualquier ventana emergente */
...
div[class*="StyledAppPage"] + div, div:has(button[title*="profile"]), div[class*="FloatingActionButton"] {
    ...
    display: none !important;
    opacity: 0 !important;
    pointer-events: none !important; /* Desactiva el mouse para que no reaccione al pasar por encima */
}

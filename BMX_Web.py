...
# --- REGLAS CSS PARA LOGRAR CABECERA AZUL Y ELIMINAR GADGETS ---
st.markdown("""
<style>
...
/* 2. Mantener ocultos los botones de desarrollo innecesarios (Fork y menú de 3 puntos) */
button#MainMenu, #MainMenu, .stActionButton, .stMainActionButton, [data-testid="stActionButton"] {
    visibility: hidden !important;
    display: none !important;
}

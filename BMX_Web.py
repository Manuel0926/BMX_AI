    ...
    with st.sidebar:
        ...
        if not st.session_state.suscrito:
            ...
            if st.button(L["cerrar_sesion"]):
                ...
                st.rerun()
# --- ÁREA CENTRAL ---
# RECTIFICACIÓN: Pasamos obligatoriamente el número 2 como argumento para definir la rejilla
...
with col_control_2:
    # Captura transparente y forzada de la aplicación saltando el Iframe de Streamlit
    st.markdown(

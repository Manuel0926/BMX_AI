...
# --- ELIMINACIÓN DE GADGETS SUPERIORES E INFERIORES COMPROBADA ---
st.markdown("""
<style>
...
/* 3. Asegurar que el encabezado mantenga el fondo azul de tu marca */
...
/* Mantener única y exclusivamente activo el botón con el icono de Imprimir/Share nativo */
button[data-testid="stHeaderActionButton"], [data-testid="stHeaderActionButton"] {
    visibility: visible !important;
...
class BMXWebScanner:
    ...
    def obtener_cliente(self):
        # Extracción e inicialización segura del cliente unificado moderno con v1beta para RAG
...
with st.sidebar:
    ...
    if not st.session_state.suscrito:
        ...
        # EXTRACCIÓN REAL DE TUS VECTOR STORES CONECTADOS A TU PROYECTO
        try:
            ...
            try:
                ...
                with st.chat_message("assistant"):
                    with st.spinner(L["spinner_vector"]):
                        ...
                        # MODELO CORRECTO Y COMPATIBLE CON LA VERSIÓN v1beta PARA EXTRAER TUS ENLACES VECTORIALES

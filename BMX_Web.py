...
# Forzamos los parámetros base del layout para que la barra lateral cargue abierta por defecto
st.set_page_config(
...
# --- REGLAS CSS PARA LOGRAR CABECERA AZUL Y ELIMINAR NUEVOS GADGETS ---
st.markdown("""
<style>
...
/* 2. ELIMINACIÓN DE LOS NUEVOS GADGETS: Ocultar botones "Fork", "GitHub", enlaces internos y menú de 3 puntos */
button#MainMenu, #MainMenu, 
.stActionButton, .stMainActionButton, [data-testid="stActionButton"],
header a, header span, .stAppHeader a, .stAppHeader span,
button:has(svg[class*="github"]), button:contains("Fork") {
    visibility: hidden !important;
    display: none !important;
}

/* 3. Forzar que los botones de control (como el de imprimir y expandir/contraer) queden encima */
...
/* 4. Asegurar el color de fondo azul en el cuerpo general de la aplicación */
.stApp {
    background-color: #7CB4E6 !important;
}

/* 5. Ocultar la barra inferior 'Manage app' y el pie de página de la nube */

...
# --- REGLAS CSS PARA CORREGIR EL RECORTE Y MANTENER LA APLICACIÓN LIMPIA ---
st.markdown("""
<style>
...
/* 2. RECTIFICACIÓN CRÍTICA: Quitamos el margen negativo destructivo para evitar los textos recortados */
.stApp {
    background-color: #7CB4E6 !important;
}

/* Forzar que los textos y títulos de Streamlit inicien con un espaciado superior óptimo y limpio */

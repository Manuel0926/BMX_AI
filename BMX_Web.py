...
# --- ELIMINACIÓN RADICAL DE GADGETS EN LA NUEVA ACTUALIZACIÓN DE STREAMLIT ---
st.markdown("""
<style>
...
/* 2. OCULTAR LOS NUEVOS GADGETS: Borra los botones "Fork" y el icono de GitHub inyectados en la cabecera */
...
/* FORZAR VISIBILIDAD: Mantener única y exclusivamente activo el botón con el icono de Imprimir/Share nativo */
...
class BMXWebScanner:
    ...
    def configurar_api(self):
        ...
        if not api_key_segura:
            raise ValueError("No se detectó 'GEMINI_API_KEY' in los Secrets de Streamlit.")

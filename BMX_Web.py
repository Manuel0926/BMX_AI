...
# --- CSS RADICAL: ELIMINA DE RAÍZ CUALQUIER ELEMENTO O ACCIÓN DE STREAMLIT CLOUD ---
st.markdown("""
<style>
...
/* 3. REFUERZO ABSOLUTO ANTI-GADGETS: Desactiva visualmente e inhabilita las acciones del mouse en la esquina inferior */
...
div[class*="stToolbar"], div[class*="AppDeployDropdown"], iframe[title*="badge"] {
    visibility: hidden !important;
    display: none !important;
    pointer-events: none !important; /* El mouse ignora por completo la zona */
}

/* Ocultar el marco del visor e insignias del hosting gratuito */
